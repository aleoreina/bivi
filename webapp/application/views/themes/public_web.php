...
<nav class="navbar navbar-default" role="navigation">
  ...
  <div class="navbar-header">
    ...
    <a class="navbar-brand" href="<?php echo base_url(); ?>"><img src="<?php echo base_url(); ?>assets/themes/default/images/logo.png"></img></a>
  </div>
...
<?php } ?>
    ...
    <div class="row">
      ...
      <footer><P align="center" ><b>BIVI</b> - Es un buscador de Tesis e Informe de pasantias para las universidades, mediante una base de datos autogestionada .</P></div>
      </footer>
